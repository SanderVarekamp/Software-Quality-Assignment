...
class Employee:
    def __init__(self, FirstName, LastName, Age, Gender, Weight, Address, City, Email, PhoneNumb, IsConsult, IsSysAdm, IsSupAdm):
        ...
        self.RegistrationDate = datetime.date.today()
        self.MemberID = self.GenerateMemberID()

    def GenerateMemberID(self):
        Numb0 = int(str(self.RegistrationDate)[2])
        Numb1 = int(str(self.RegistrationDate)[3])
        ...
        return int(str(Numb0) + str(Numb1) + str(Numb2) + str(Numb3) +
