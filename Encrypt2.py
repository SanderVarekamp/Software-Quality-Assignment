...
class RSASystem:
    ...
    def decrypt_members(self, db_path, given_name):
        ...
        for row in rows:
            ...
            if decrypted_data[0] == given_name:
...
if __name__ == "__main__":
    ...
    # system.encrypt_member(AccountManager.SearchAccountForce("admin"))
    # system.decrypt("test.db", "super_admin")
